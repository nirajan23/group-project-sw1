...
def clear_visited_locations():
    db = """ delete from visited_locations;"""
...
def main():
    ...
    print(f"Welome {player_name}, Visit two cities on each of the five continents, while staying within a budget and a CO2 limit.")
    print()
    print("Select the airport you want to start")
